...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
        ...
        <a href="{{ url('/about') }}" class="ghost-button-transition" style="position: relative; left: 10px; top: 10px; font-family: 'Lato', sans-serif;">ABOUT</a>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="" style="color: rgba(0,0,0,0.6); font-size: 65px; font-weight: lighter">
